...
function network_up() {
  ...
  push_fn "Complete apply peer, orderers"


  wait_for ibppeer org1-peer1
  push_fn "Complete org1, peer1"
  wait_for ibppeer org1-peer2
  push_fn "Complete org1, peer2"
  wait_for ibppeer org2-peer1
  push_fn "Complete org2, peer1"
  wait_for ibppeer org2-peer2
  push_fn "Complete org2, peer2"

  wait_for ibporderer org0-orderersnode1
  push_fn "Complete org0, node1"
  wait_for ibporderer org0-orderersnode2
  push_fn "Complete org1, node2"
  wait_for ibporderer org0-orderersnode3
  push_fn "Complete org2, node3"
}
